...
namespace SWManager.WatchdogManager
{
    public class WatchdogManagerService : ServiceBase
    {
        ...
        public WatchdogManagerService()
        {
            this.ServiceName = "Service Watchdog Manager Manager Service";
        ...
        static void Main()
        {
            ...
            if (Environment.UserInteractive)
            {
                ...
                WatchdogManagerService svc = new WatchdogManagerService();
        ...
        protected override void OnStart(string[] args)
        {
            ...
            if (RunningInteractively)
            {
                Console.Write("Service Watchdog Manager Starting.\r\n");
                if (FailEventLog)
                {
            ...
            else
            {
                if (!FailEventLog)
                {
                    this.EventLog.WriteEntry("Service Watchdog Manager Starting.");
                }
            }
        ...
        protected override void OnStop()
        {
            ...
            if (RunningInteractively)
            {
                Console.Write("Service Watchdog Manager Stopping.\r\n");
            }
            else
            {
                if (!FailEventLog)
                {
                    this.EventLog.WriteEntry("Service Watchdog Manager Stopping.");
                }
            }
            worker.CancelAsync();
        }
        ...
        //{
        //    this.EventLog.WriteEntry("Service Watchdog Manager Pausing.");
        //    base.OnPause();
        //}
        ...
        protected override void OnShutdown()
        {
            if (RunningInteractively)
            {
                Console.Write("Service Watchdog Manager System Shutdown.\r\n");
            }
            else
            {
                if (!FailEventLog)
                {
                    this.EventLog.WriteEntry("Service Watchdog Manager System Shutdown.");
                }
            }
            OnStop();
            base.OnShutdown();
        ...
        private void Worker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    WorkerReport InitReport = SQLiteDB.InitDatabase("ServiceWatchdogManager", dbPath);
                    if (InitReport != null)
                    {
        ...
        private void Worker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            if (RunningInteractively)
            {
                Console.Write("Service Watchdog Manager Stopped.\r\n");
            }
            else
            {
                this.EventLog.WriteEntry("Service Watchdog Manager Stopped.");
            }
        ...
        private void Worker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            if (rep != null)
            {
                if (rep.LogMessage != null)
                {
                    if (RunningInteractively)
                    {
                        Console.Write(string.Format("Service Watchdog Manager {0}\r\n", rep.LogMessage));
                    }
                    else
                    {
                        this.EventLog.WriteEntry(string.Format("Service Watchdog Manager {0}", rep.LogMessage), EventLogEntryType.Information);
                    }
                }
                if (rep.LogWarning != null)
                {
                    ...
                    {
                        this.EventLog.WriteEntry(string.Format("Service Watchdog Manager {0}", rep.LogWarning), EventLogEntryType.Warning);
                    }
                }
                if (rep.LogError != null)
                {
                    ...
                    {
                        this.EventLog.WriteEntry(string.Format("Service Watchdog Manager {0}", rep.LogError), EventLogEntryType.Error);
                    }
                }
